"""
Source:https://github.com/taesungp/contrastive-unpaired-translation/blob/master/models/stylegan_networks.py
...
class StyleGAN2Generator(nn.Module):
    def __init__(
        ...
        **kargs,
        ...
        super().__init__()
        self.opt = opt
        self.encoder = StyleGAN2Encoder(input_nc, output_nc, net_G_channel, use_dropout, net_G_depth, padding_type, no_antialias, opt)
        self.decoder = StyleGAN2Decoder(input_nc, output_nc, net_G_channel, use_dropout, net_G_depth, padding_type, no_antialias, opt)

    def forward(self, input, return_intermediate=False, layers=[], encode_only=False):
